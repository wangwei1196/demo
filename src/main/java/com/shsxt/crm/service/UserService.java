...
public class UserService extends BaseService<User>{
    ...
    public  Map<String,Object> queryUsersByParams(UserQuery userQuery){
         ...
         *          users|userList
         *          user
         *         key= users::pageNum::1::pageSize::10::userName::shsxt::email::123@163.com::phone::1232132
         *     缓存数据存在  获取缓存数据即可 方法结束
         *     缓存数据不存在
         *        查询数据库数据
         *            数据存在  存入缓存  返回结果
         *            userName=null
         ...
         *            userName=admin
         *              user:id=1  userName=admin
         *            userName=admin&email=12312@163.com
         *              user:id=1  userName=admin
         *           更新userName=admin-->userName=shsxt
         *
         *
         */
