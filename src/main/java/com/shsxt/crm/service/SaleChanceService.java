...
public class SaleChanceService extends BaseService<SaleChance> {
    ...
    public Map<String,Object> querySaleChancesByParams(SaleChanceQuery saleChanceQuery){
        ...
        if(CollectionUtils.isEmpty(saleChances)){
            ...
            saleChances=saleChanceDao.queryByParams(saleChanceQuery);
            Page<SaleChance> page= (Page<SaleChance>) saleChances;
            System.out.println("总数:"+page.getTotal()+":总页数:"+page.getPages()+":结束行:"+page.getEndRow());
            PageInfo<SaleChance> pageInfo=null;
            pageInfo=new PageInfo<SaleChance>(saleChances);
